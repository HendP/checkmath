 ...
 */
public class Ui_soal_sma extends javax.swing.JFrame {
    int Sec=1800;
    Soalll baru;
    KumpulanSoalll set;
     ...
     */
    public Ui_soal_sma() throws InterruptedException {
        initComponents();
        timer();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 372, 256));
        ...
        getContentPane().add(btnA, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 177, 55));
        ...
        getContentPane().add(btnC, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 400, 177, 55));
        ...
        getContentPane().add(btnB, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 177, 55));
        ...
        getContentPane().add(btnD, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 177, 55));
        ...
        getContentPane().add(Timer1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 70, -1));
        ...
        getContentPane().add(lblLife, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 120, -1));
        getContentPane().add(Life, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 0, 100, 40));
        ...
        getContentPane().add(btnSurrender, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, -1, -1));

        lblGedung.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gedung1.png"))); // NOI18N
        lblGedung.setPreferredSize(new java.awt.Dimension(35, 15));
        getContentPane().add(lblGedung, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 221, 440));

        jLabel2.setFont(new java.awt.Font("Kristen ITC", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Level SMA");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 258, 70));

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/dubai.jpg"))); // NOI18N
        getContentPane().add(Background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 640, 550));
    ...
    private void wronganswer(){
        //JOptionPane.showMessageDialog(null, "JAWABAN ANDA SALAH\nCOBA LAGIII !!!\nNyawa Anda : "+pemain.getLife(), "INFORMASI", JOptionPane.INFORMATION_MESSAGE);
        fal.setVisible(true);
        j = j-1;
            if(j == 2){
    ...
    private void gameover(){
        time.suspend();
        dispose();
        KalahNyawa kn = new KalahNyawa(this,true,pemain.get_nama(),pemain.get_skor(),baru.get_pilihan(0),"SMA");
        kn.setVisible(true);
        dispose();
        pemain.set_skor(pemain.get_skor()+(Sec*4));
        save_highscore();
    }
    ...
    private void Next(){
            ...
            i++;
            if(baru!=null){
            ImageIcon II = new ImageIcon(getClass().getResource("/img/gedung"+i+".png"));
            lblGedung.setIcon(II);
            txtSoal.setText(baru.Get_Soal());
            switch(baru.get_jawaban()){
            case 0 : 
    ...
    private void save_highscore(){
        ...
        score.TambahHighScoreSMA(pemain);
        score.Simpan();
        pemain.set_nama();
        //pemain.resetskor();
    }
    ...
    public void kalah_waktu(){
        KalahWaktu kw = new KalahWaktu(this,true,pemain.get_nama(),pemain.get_skor(),baru.get_pilihan(0),"SMA");
        kw.setVisible(true);
    }
    ...
    private void btnSurrenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSurrenderActionPerformed
        ...
        Sound.SoundButton();
        time.suspend();
        MenyerahSMA mm = new MenyerahSMA(this,true,time,this);
        mm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ui_soal_sma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Ui_soal_sma().setVisible(true);
                } catch (InterruptedException ex) {
                    Logger.getLogger(Ui_soal_sma.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
