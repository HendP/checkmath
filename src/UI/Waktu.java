 ...
 */
public class Waktu extends javax.swing.JDialog {

    /**
     * Creates new form Waktu
     */
    public Waktu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnOkay, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/jam.gif"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 100, 100));

        jLabel2.setFont(new java.awt.Font("Ubuntu-Title", 0, 18)); // NOI18N
        jLabel2.setText("Waktu Tinggal 5 Menit (300 Detik)");
        ...
        setSize(new java.awt.Dimension(369, 157));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Waktu dialog = new Waktu(new javax.swing.JFrame(), true);
